 ...
 * stats.inc.php
 *
 * Linkage game statistics description
 *
 */
...
$stats_type = array(
    ...
    "player" => array(
        ...
        "pieces_played_corner" => array("id"=> 51,
        "name" => totranslate("Number of pieces played in corner"),
        "type" => "int" ),

        "pieces_played_corner_percentage" => array("id"=> 52,
        "name" => totranslate("Percentage of pieces played in corner"),
        "type" => "int" ),
    )
